# Awesome Reinforcement Learning with stars

This page is no longer maintained.

A curated list of resources dedicated to reinforcement learning.

We have pages for other topics: [awesome-rnn](https://github.com/kjw0612/awesome-rnn) ⭐ 6,210 | 🐛 4 | 📅 2022-02-03, [awesome-deep-vision](https://github.com/kjw0612/awesome-deep-vision) ⭐ 11,177 | 🐛 47 | 📅 2023-08-15, [awesome-random-forest](https://github.com/kjw0612/awesome-random-forest) ⭐ 1,252 | 🐛 3 | 📅 2023-11-16

Maintainers: [Hyunsoo Kim](http://sites.duke.edu/hyunsookim/), [Jiwon Kim](http://github.com/kjw0612)

## Contributing

Please feel free to [pull requests](https://github.com/aikorea/awesome-rl/pulls) ⭐ 9,913 | 🐛 7 | 📅 2023-05-25
...
* [OpenAI Baselines](https://github.com/openai/baselines) ⭐ 16,750 | 🐛 502 | 🌐 Python | 📅 2024-08-01 - Well tested implementations ([and results](https://github.com/openai/baselines-results) ⚠️ Archived) of reinforcement learning algorithms from OpenAI
* [Reinforcement Learning Examples by RLCode](https://github.com/rlcode/reinforcement-learning) ⭐ 3,661 | 🐛 0 | 🌐 Python | 📅 2026-06-12 - A Collection of minimal and clean reinforcement learning examples
* [PyTorch Deep RL](https://github.com/ShangtongZhang/DeepRL) ⭐ 3,443 | 🐛 8 | 🌐 Python | 📅 2024-04-16 - Popular deep RL algorithm implementations with PyTorch
* [ChainerRL](https://github.com/chainer/chainerrl) ⭐ 1,199 | 🐛 65 | 🌐 Python | 📅 2021-08-10 - Popular deep RL algorithm implementations with Chainer
...
* [Jumanji](https://github.com/instadeepai/jumanji) ⭐ 855 | 🐛 26 | 🌐 Python | 📅 2026-08-04 - A Suite of Industry-Driven Hardware-Accelerated RL Environments written in JAX.
...
* Codes for examples and exercises in Richard Sutton and Andrew Barto's Reinforcement Learning: An Introduction
  * [Python Code](https://github.com/ShangtongZhang/reinforcement-learning-an-introduction) ⭐ 14,746 | 🐛 22 | 🌐 Python | 📅 2024-08-09
  * [Exercise Solutions](https://github.com/LyWangPX/Reinforcement-Learning-2nd-Edition-by-Sutton-Exercise-Solutions) ⭐ 2,428 | 🐛 23 | 🌐 Jupyter Notebook | 📅 2025-07-10
...
* \[UCL] [COMPMI22/COMPGI22 - Advanced Deep Learning and Reinforcement Learning](https://github.com/enggen/DeepMind-Advanced-Deep-Learning-and-Reinforcement-Learning) ⭐ 863 | 🐛 3 | 📅 2019-06-20
...
* Richard Sutton and Andrew Barto, Reinforcement Learning: An Introduction (2nd Edition, in progress, 2018) [\[Book\]](http://incompleteideas.net/book/RLbook2020.pdf) [\[Code\]](https://github.com/ShangtongZhang/reinforcement-learning-an-introduction) ⭐ 14,746 | 🐛 22 | 🌐 Python | 📅 2024-08-09
...
* Flappy Bird - Sarvagya Vaish, [Flappy Bird Reinforcement Learning](https://github.com/SarvagyaVaish/FlappyBirdRL) ⭐ 919 | 🐛 1 | 🌐 JavaScript | 📅 2017-11-15 [\[Video\]](https://www.youtube.com/watch?v=xM62SpKAZHU)
...
* Konstantinos Chatzilygeroudis, Roberto Rama, Rituraj Kaushik et al, Black-Box Data-efficient Policy Search for Robotics (IROS 2017) \[[ArXiv](https://arxiv.org/abs/1703.07261)] \[[Video](https://www.youtube.com/watch?v=kTEyYiIFGPM)] \[[Code](https://github.com/resibots/blackdrops) ⭐ 66 | 🐛 8 | 🌐 C++ | 📅 2021-11-17]
* Antoine Cully, Jeff Clune, Danesh Tarapore and Jean-Baptiste Mouret, Robots that can adapt like animals (Nature 2015) \[[ArXiv](https://arxiv.org/abs/1407.3501)] \[[Video](https://www.youtube.com/watch?v=T-c17RKh3uE)] \[[Code](https://github.com/resibots/cully_2015_nature) ⭐ 36 | 🐛 2 | 🌐 Shell | 📅 2018-10-24]
...
* Codes for examples and exercises in Richard Sutton and Andrew Barto's [Book](#books) Reinforcement Learning: An Introduction
  * [Python Code](https://github.com/ShangtongZhang/reinforcement-learning-an-introduction) ⭐ 14,746 | 🐛 22 | 🌐 Python | 📅 2024-08-09 (2nd Edition)
...
* [Practical\_RL](https://github.com/yandexdataschool/Practical_RL) ⭐ 6,555 | 🐛 43 | 🌐 Jupyter Notebook | 📅 2026-03-31 - github-based course in reinforcement learning in the wild (lectures, coding labs, projects)
...
* [Deep Q-Learning with Tensor Flow](https://github.com/nivwusquorum/tensorflow-deepq) ⭐ 1,166 | 🐛 6 | 🌐 Jupyter Notebook | 📅 2017-05-24 - A deep Q learning demonstration using Google Tensorflow
...
* [Unity ML Agents](https://github.com/Unity-Technologies/ml-agents) ⭐ 19,625 | 🐛 17 | 🌐 C# | 📅 2026-08-12 - Create reinforcement learning environments using the Unity Editor
...
* [Project Malmo](https://github.com/Microsoft/malmo) ⭐ 4,270 | 🐛 171 | 🌐 Java | 📅 2025-09-03 - A platform for Artificial Intelligence experimentation and research built on top of Minecraft by Microsoft
...
* [tf-TRFL](https://github.com/deepmind/trfl/) ⭐ 3,132 | 🐛 6 | 🌐 Python | 📅 2022-12-08 - A library built on top of TensorFlow that exposes several useful building blocks for implementing Reinforcement Learning agents.
* [garage](https://github.com/rlworkgroup/garage) ⭐ 2,123 | 🐛 234 | 🌐 Python | 📅 2023-05-04 - A framework for reproducible reinformcement learning research, fully compatible with OpenAI Gym and DeepMind Control Suite (successor to rllab)
* [ViZDoom](https://github.com/Marqt/ViZDoom) ⭐ 2,059 | 🐛 39 | 🌐 C++ | 📅 2026-08-13 - Doom-based AI research platform for reinforcement learning from raw visual information
...
* [SLM Lab](https://github.com/kengz/SLM-Lab) ⭐ 1,362 | 🐛 5 | 🌐 Python | 📅 2026-06-20 - A research framework for Deep Reinforcement Learning using Unity, OpenAI Gym, PyTorch, Tensorflow.
* [Jumanji](https://github.com/instadeepai/jumanji) ⭐ 855 | 🐛 26 | 🌐 Python | 📅 2026-08-04 - A Suite of Industry-Driven Hardware-Accelerated RL Environments written in JAX.
...
* [Retro Learning Environment](https://github.com/nadavbh12/Retro-Learning-Environment) ⭐ 186 | 🐛 5 | 🌐 C++ | 📅 2018-06-06 - An AI platform for reinforcement learning based on video game emulators. Currently supports SNES and Sega Genesis. Compatible with OpenAI gym.
* [keras-rl](https://github.com/matthiasplappert/keras-rl) ⭐ 12 | 🐛 0 | 📅 2022-05-23 - State-of-the art deep reinforcement learning algorithms in Keras designed for compatibility with OpenAI.
