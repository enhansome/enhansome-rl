...
We have pages for other topics: [awesome-rnn](https://github.com/kjw0612/awesome-rnn) ⭐ 6,211 | 🐛 4 | 📅 2022-02-03, [awesome-deep-vision](https://github.com/kjw0612/awesome-deep-vision) ⭐ 11,188 | 🐛 48 | 📅 2023-08-15, [awesome-random-forest](https://github.com/kjw0612/awesome-random-forest) ⭐ 1,255 | 🐛 3 | 📅 2023-11-16

Maintainers: [Hyunsoo Kim](http://sites.duke.edu/hyunsookim/), [Jiwon Kim](http://github.com/kjw0612)

## Contributing

Please feel free to [pull requests](https://github.com/aikorea/awesome-rl/pulls) ⭐ 9,980 | 🐛 7 | 📅 2023-05-25
...
* [OpenAI Baselines](https://github.com/openai/baselines) ⭐ 16,763 | 🐛 502 | 🌐 Python | 📅 2024-08-01 - Well tested implementations ([and results](https://github.com/openai/baselines-results) ⚠️ Archived) of reinforcement learning algorithms from OpenAI
* [Reinforcement Learning Examples by RLCode](https://github.com/rlcode/reinforcement-learning) ⭐ 3,664 | 🐛 0 | 🌐 Python | 📅 2026-06-12 - A Collection of minimal and clean reinforcement learning examples
* [PyTorch Deep RL](https://github.com/ShangtongZhang/DeepRL) ⭐ 3,454 | 🐛 8 | 🌐 Python | 📅 2024-04-16 - Popular deep RL algorithm implementations with PyTorch
...
* [Jumanji](https://github.com/instadeepai/jumanji) ⭐ 863 | 🐛 28 | 🌐 Python | 📅 2026-09-09 - A Suite of Industry-Driven Hardware-Accelerated RL Environments written in JAX.
...
* Codes for examples and exercises in Richard Sutton and Andrew Barto's Reinforcement Learning: An Introduction
  ...
  * [Exercise Solutions](https://github.com/LyWangPX/Reinforcement-Learning-2nd-Edition-by-Sutton-Exercise-Solutions) ⭐ 2,437 | 🐛 23 | 🌐 Jupyter Notebook | 📅 2025-07-10
...
* Richard Sutton and Andrew Barto, Reinforcement Learning: An Introduction (2nd Edition, in progress, 2018) [\[Book\]](http://incompleteideas.net/book/RLbook2020.pdf) [\[Code\]](https://github.com/ShangtongZhang/reinforcement-learning-an-introduction) ⭐ 14,763 | 🐛 22 | 🌐 Python | 📅 2024-08-09
...
* Codes for examples and exercises in Richard Sutton and Andrew Barto's [Book](#books) Reinforcement Learning: An Introduction
  * [Python Code](https://github.com/ShangtongZhang/reinforcement-learning-an-introduction) ⭐ 14,763 | 🐛 22 | 🌐 Python | 📅 2024-08-09 (2nd Edition)
...
* [Practical\_RL](https://github.com/yandexdataschool/Practical_RL) ⭐ 6,577 | 🐛 43 | 🌐 Jupyter Notebook | 📅 2026-03-31 - github-based course in reinforcement learning in the wild (lectures, coding labs, projects)
...
* [Unity ML Agents](https://github.com/Unity-Technologies/ml-agents) ⭐ 19,696 | 🐛 21 | 🌐 C# | 📅 2026-09-17 - Create reinforcement learning environments using the Unity Editor
...
* [DeepMind Lab](https://github.com/deepmind/lab) ⭐ 7,381 | 🐛 67 | 🌐 C | 📅 2023-01-04 - A customisable 3D platform for agent-based AI research
...
* [garage](https://github.com/rlworkgroup/garage) ⭐ 2,129 | 🐛 235 | 🌐 Python | 📅 2023-05-04 - A framework for reproducible reinformcement learning research, fully compatible with OpenAI Gym and DeepMind Control Suite (successor to rllab)
* [ViZDoom](https://github.com/Marqt/ViZDoom) ⭐ 2,083 | 🐛 39 | 🌐 C++ | 📅 2026-09-21 - Doom-based AI research platform for reinforcement learning from raw visual information
* [MAgent](https://github.com/geek-ai/MAgent) ⭐ 1,760 | 🐛 31 | 🌐 Python | 📅 2022-10-22 - A Platform for Many-agent Reinforcement Learning.
