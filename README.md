...
Please feel free to [pull requests](https://github.com/aikorea/awesome-rl/pulls) ⭐ 9,953 | 🐛 7 | 📅 2023-05-25
...
* [Jumanji](https://github.com/instadeepai/jumanji) ⭐ 862 | 🐛 28 | 🌐 Python | 📅 2026-09-09 - A Suite of Industry-Driven Hardware-Accelerated RL Environments written in JAX.
...
* [Unity ML Agents](https://github.com/Unity-Technologies/ml-agents) ⭐ 19,672 | 🐛 21 | 🌐 C# | 📅 2026-09-02 - Create reinforcement learning environments using the Unity Editor
...
* [DeepMind Lab](https://github.com/deepmind/lab) ⭐ 7,377 | 🐛 67 | 🌐 C | 📅 2023-01-04 - A customisable 3D platform for agent-based AI research
...
* [ViZDoom](https://github.com/Marqt/ViZDoom) ⭐ 2,069 | 🐛 40 | 🌐 C++ | 📅 2026-09-13 - Doom-based AI research platform for reinforcement learning from raw visual information
