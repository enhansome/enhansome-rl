...
We have pages for other topics: [awesome-rnn](https://github.com/kjw0612/awesome-rnn) ⭐ 6,210 | 🐛 4 | 📅 2022-02-03, [awesome-deep-vision](https://github.com/kjw0612/awesome-deep-vision) ⭐ 11,185 | 🐛 47 | 📅 2023-08-15, [awesome-random-forest](https://github.com/kjw0612/awesome-random-forest) ⭐ 1,254 | 🐛 3 | 📅 2023-11-16

Maintainers: [Hyunsoo Kim](http://sites.duke.edu/hyunsookim/), [Jiwon Kim](http://github.com/kjw0612)

## Contributing

Please feel free to [pull requests](https://github.com/aikorea/awesome-rl/pulls) ⭐ 9,938 | 🐛 7 | 📅 2023-05-25
...
* [Jumanji](https://github.com/instadeepai/jumanji) ⭐ 861 | 🐛 25 | 🌐 Python | 📅 2026-09-04 - A Suite of Industry-Driven Hardware-Accelerated RL Environments written in JAX.
...
* [Practical\_RL](https://github.com/yandexdataschool/Practical_RL) ⭐ 6,569 | 🐛 43 | 🌐 Jupyter Notebook | 📅 2026-03-31 - github-based course in reinforcement learning in the wild (lectures, coding labs, projects)
...
* [Unity ML Agents](https://github.com/Unity-Technologies/ml-agents) ⭐ 19,661 | 🐛 21 | 🌐 C# | 📅 2026-09-02 - Create reinforcement learning environments using the Unity Editor
...
* [ViZDoom](https://github.com/Marqt/ViZDoom) ⭐ 2,065 | 🐛 39 | 🌐 C++ | 📅 2026-09-06 - Doom-based AI research platform for reinforcement learning from raw visual information
