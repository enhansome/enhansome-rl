...
We have pages for other topics: [awesome-rnn](https://github.com/kjw0612/awesome-rnn) ⭐ 6,210 | 🐛 4 | 📅 2022-02-03, [awesome-deep-vision](https://github.com/kjw0612/awesome-deep-vision) ⭐ 11,186 | 🐛 47 | 📅 2023-08-15, [awesome-random-forest](https://github.com/kjw0612/awesome-random-forest) ⭐ 1,254 | 🐛 3 | 📅 2023-11-16

Maintainers: [Hyunsoo Kim](http://sites.duke.edu/hyunsookim/), [Jiwon Kim](http://github.com/kjw0612)

## Contributing

Please feel free to [pull requests](https://github.com/aikorea/awesome-rl/pulls) ⭐ 9,937 | 🐛 7 | 📅 2023-05-25
...
* [OpenAI Baselines](https://github.com/openai/baselines) ⭐ 16,759 | 🐛 502 | 🌐 Python | 📅 2024-08-01 - Well tested implementations ([and results](https://github.com/openai/baselines-results) ⚠️ Archived) of reinforcement learning algorithms from OpenAI
...
* [Jumanji](https://github.com/instadeepai/jumanji) ⭐ 860 | 🐛 25 | 🌐 Python | 📅 2026-09-04 - A Suite of Industry-Driven Hardware-Accelerated RL Environments written in JAX.
...
* [Practical\_RL](https://github.com/yandexdataschool/Practical_RL) ⭐ 6,566 | 🐛 43 | 🌐 Jupyter Notebook | 📅 2026-03-31 - github-based course in reinforcement learning in the wild (lectures, coding labs, projects)
...
* [Unity ML Agents](https://github.com/Unity-Technologies/ml-agents) ⭐ 19,660 | 🐛 21 | 🌐 C# | 📅 2026-09-02 - Create reinforcement learning environments using the Unity Editor
...
* [TensorForce](https://github.com/reinforceio/tensorforce) ⭐ 3,304 | 🐛 45 | 🌐 Python | 📅 2026-09-02 - Practical deep reinforcement learning on TensorFlow with Gitter support and OpenAI Gym/Universe/DeepMind Lab integration.
...
* [ViZDoom](https://github.com/Marqt/ViZDoom) ⭐ 2,065 | 🐛 38 | 🌐 C++ | 📅 2026-09-04 - Doom-based AI research platform for reinforcement learning from raw visual information
